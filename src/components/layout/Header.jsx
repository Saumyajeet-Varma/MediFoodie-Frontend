            ...
            {isOpen && (
                <div className="md:hidden bg-purple-700">
                    <div className="px-4 py-3 space-y-2 flex flex-col">
                        ...
                        <Link to="/profile" onClick={toggleMenu} className="hover:text-gray-200">Profile</Link>
                        <Link to="/login" onClick={toggleMenu} className="hover:text-gray-200">Login</Link>
                    </div>
                </div>
            )}
        </nav>
